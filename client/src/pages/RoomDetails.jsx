    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'>
            <div className='flex flex-col'>
                <h1 className='text-3xl mf:text-4xl font-playfair'>Experience Luxury Like Never Before</h1>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p>Guests will be allocated on the ground floor according to availability. You get a comfortable room with a private balcony. The room has a private bathroom with a shower and a hairdryer. You can also make use of the kitchenette which includes a microwave, a fridge, and a coffee maker. You can also make use of the dining area. The room is equipped with a flat-screen TV with cable channels.</p>
...
{/* Hosted by */}
            <div className='flex flex-col items-start gap-4'>
                <div className='flex gap-4'>
                    <img src={room.hotel.owner.image} alt='Host' className='h-14 w-14 rounded-full md:h-18 md:w-18 ' />
                    <div>
